...
<body>
            ...
            <tbody>
                ...
                if($result){
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$description.'</td>
                        <td>'.$prix.'€</td>
                        <td><img style="width:170px;px" src="'.$image.'" alt=""></td>
                        <td>'.$ville.'</td> 
                        <td>'.$codepostal.'</td> 
                        <td>
                            <button class="btn btn-secondary"><a class="text-white" href="product.php?updateid='.$id_produit.'">Consulter produit</a></button></td>                       
                        </tr>';
                    }
                }               
                ?>     
    ...
    <img style="width:20px" src="pixabay.com/images/id-3352363/" alt="">
</body>
</html>
